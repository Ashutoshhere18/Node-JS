...
//   try{
//    await axios.post(`${base_uri}/auth/signup`,user);
//   }catch(err){
//     alert(err.message);
//   }
//  }
...
//   <input type="password" value={confirm} onChange={(e)=>setConfirmPassword(e.target.value)}  className="form-control" id="exampleFormControlInput3" placeholder="confirm password"/>
// </div>
// <div className="mb-3">
